...
@echo "=== building siga-1.10.8 theme"
@echo "===== copying dojo files"
@echo "===== copying dojo/manager files"
rmdir /Q/S %current%\themes\siga-1.10.8\css\dojo
rmdir /Q/S %current%\themes\siga-1.10.8\css\manager
xcopy /Y/E/I  %dojo%\*.* %current%\themes\siga-1.10.8\css\dojo
xcopy /Y/E/I  %manager%\*.* %current%\themes\siga-1.10.8\css\manager
